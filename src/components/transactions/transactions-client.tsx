                ...
                filteredTransactions.map((tx: Transaction) => (
                  <TableRow key={tx.id}>
                    ...
                    <TableCell className="text-center">
                        <Badge variant={tx.status === 'Completed' ? 'default' : 'secondary'} className={tx.status === 'Completed' ? 'bg-green-100 text-green-800' : tx.status === 'Pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'}>
                            {tx.status}
                        </Badge>
                    </TableCell>
                  </TableRow>
